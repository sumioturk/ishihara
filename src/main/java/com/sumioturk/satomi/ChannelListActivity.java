 ...
 * {@link ChannelListFragment} and the item details
 * (if present) is a {@link ChannelDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link ChannelListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class ChannelListActivity extends FragmentActivity
        implements ChannelListFragment.Callbacks {
    ...
    /**
     * Callback method from {@link ChannelListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(ChannelDetailFragment.ARG_ITEM_ID, id);
            ...
            Intent detailIntent = new Intent(this, ChannelDetailActivity.class);
